...
IMPORTANTE: Todos los datos que precises para llevar a cabo una acción debes pedirlos de una sola vez. Si necesitas más de un dato, solicita todos a la vez y usa `ExitLoopSignalTool(reason="Esperando datos del usuario")` para pausar la conversación.
